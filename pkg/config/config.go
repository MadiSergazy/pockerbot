...
//mapstructure for retriving using libary viper
...
func unmarshal(cfg *Config) error { //for parsing rest of configs
...
func setUpViper() error {
	viper.AddConfigPath("configs") //path to file configs
	viper.SetConfigName("main")    //name of file
